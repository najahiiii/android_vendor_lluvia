...
LLUVIA_MOD_VERSION := Storm
LLUVIA_VERSION := LLuviaOS-$(LLUVIA_VERSION_NUMBER)-$(LLUVIA_MOD_VERSION)-$(LLUVIA_BUILD_TYPE)-$(shell date -u +%Y%m%d)
...
ifeq ($(TARGET_BOOT_ANIMATION_RES),720)
     PRODUCT_COPY_FILES += vendor/lluvia/media/bootanimation.zip:system/media/bootanimation.zip
