...
LLUVIA_VERSION := $(LLUVIA_VERSION_NUMBER)-$(shell date -u +%Y%m%d)-$(LLUVIA_BUILDTYPE)-$(LLUVIA_BUILD)
...
ifeq ($(TARGET_BOOT_ANIMATION_RES),720)
     PRODUCT_COPY_FILES += vendor/lluvia/media/bootanimation_720.zip:system/media/bootanimation.zip
else ifeq ($(TARGET_BOOT_ANIMATION_RES),1080)
     PRODUCT_COPY_FILES += vendor/lluvia/media/bootanimation_1080.zip:system/media/bootanimation.zip
else ifeq ($(TARGET_BOOT_ANIMATION_RES),1440)
     PRODUCT_COPY_FILES += vendor/lluvia/media/bootanimation_1440.zip:system/media/bootanimation.zip
else
