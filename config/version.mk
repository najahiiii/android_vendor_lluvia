...
PRODUCT_VERSION_MINOR = σταθερός
...
LLUVIA_BUILD_VERSION := $(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)
LLUVIA_VERSION := $(LLUVIA_BUILD_VERSION)-$(LLUVIA_BUILDTYPE)-$(LLUVIA_BUILD)-$(DATE)
